  ...
  module Metadata
    ...
    class QualifiedDublinCore < DRI::Metadata::Base
      ...
      def set_delegates model
        ...
        attributes = DRI::Vocabulary::marcRelators.map { |s| s.prepend("role_").to_sym}
        attributes.each { |a| model.class.has_attributes a, datastream: :descMetadata, multiple: true }
      end

...
class GenericFileIndexer
  ...
  def to_solr
    ...
    solr_doc['duration_isi'] = resource.wrapped_object.milliseconds[0] unless resource.wrapped_object.milliseconds.blank?
    solr_doc['channels_isi'] = resource.wrapped_object.channels[0] unless resource.wrapped_object.channels.blank?
    solr_doc['sample_rate_isi'] = resource.wrapped_object.sample_rate[0].to_i unless resource.wrapped_object.sample_rate.blank?
    solr_doc['mime_type_tesim'] = resource.wrapped_object.mime_type unless resource.wrapped_object.mime_type.blank?

  ...
  module Metadata
    ...
    class EncodedArchivalDescription < DRI::Metadata::Base
      ...
      set_terminology do |t|
        ...
        t.resource_type(proxy: [:ead, :arch_desc, :did, :phys_desc, :genre_form], index_as: [Descriptors.cleaned_facetable, Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])

  ...
  module Marc
    def load_inherited_terminology
      ...
      set_terminology do |t|
        ...
        t.personal_name(path: 'record/datafield[@tag="100" or @tag="700"]')
        t.corporate_name(path: 'record/datafield[@tag="110" or @tag="710"]')
        t.meeting_name(path: 'record/datafield[@tag="711"]')
        ...
        t.relation_ids_isVersionOf(path: 'record/datafield[@tag="775"]/subfield[@code="o"]', index_as: [DRI::Metadata::Descriptors.cleaned_searchable, DRI::Metadata::Descriptors.cleaned_displayable])

     ...
     # Set OM (Opinionated Metadata) terminology
      def load_inherited_terminology
        set_terminology do |t|
          ...
          t.source(path: 'source', namespace_prefix: 'dc', index_as: [DRI::Metadata::Descriptors.cleaned_facetable, DRI::Metadata::Descriptors.cleaned_searchable]) {
          ...
          t.relation(namespace_prefix: 'dc', index_as: [DRI::Metadata::Descriptors.cleaned_facetable, DRI::Metadata::Descriptors.cleaned_displayable])
          t.external_relation(path: 'relation', namespace_prefix: 'dc', attributes: { 'xsi:type' => 'dcterms:URI' }, 
            index_as: [DRI::Metadata::Descriptors.cleaned_facetable, DRI::Metadata::Descriptors.cleaned_displayable])

module DRI
  ...
  module Metadata
    ...
    # An ActiveFedora datastream that interacts with Qualified marc Metadata.
    ...
    class Marc < DRI::Metadata::Base
      ...
      def self.load_inherited_terminology
        set_terminology do |t|
          ...
          # Marc Fields
          # t.record{
          #   t.leader(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          # }
          t.record(:namespace_prefix=>nil, :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])

          # # Simple Dublin Core Fields
          # t.title(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          #
          # t.rights(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          # t.description(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          # t.language(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_searchable, Descriptors.language_facetable])
          # t.subject(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_facetable, Descriptors.cleaned_displayable]) {
          #   t.subject_lang(:path=>{:attribute=> "xml:lang"})
          # }
          # t.subject_lang(:proxy=>[:subject, :subject_lang])
          # t.date(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          # t.contributor(:path=>"contributor", :namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_facetable, Descriptors.cleaned_searchable])
          # t.source(:path=>"source", :namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_displayable, Descriptors.cleaned_facetable])
          # t.publisher(:path=>"publisher", :namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_facetable, Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          # t.coverage(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_displayable]) {
          #   t.coverage_lang(:path=>{:attribute=> "xml:lang"})
          # }
          # t.relation(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_displayable, Descriptors.cleaned_facetable])
          # t.creator(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_facetable, Descriptors.cleaned_searchable, Descriptors.cleaned_displayable,  :sortable])
          # t.format(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_facetable, Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          # t.type(:namespace_prefix=>"marc", :index_as=>[Descriptors.cleaned_facetable, Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          #
          # # No need to index, but useful for editing
          # t.identifier(:namespace_prefix=>"marc")
          #
          # # Qualified Dublin Core fields
          # t.published_date(:path=>"issued", :namespace_prefix=>"marcterms", :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          # t.creation_date(:path=>"created", :namespace_prefix=>"marcterms", :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          # t.geographical_coverage(:path=>"spatial", :namespace_prefix=>"marcterms", :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_facetable, Descriptors.cleaned_displayable])  {
          #   t.geographical_coverage_lang(:path=>{:attribute=> "xml:lang"})
          # }
          # t.temporal_coverage(:path=>"temporal", :namespace_prefix=>"marcterms", :index_as=>[Descriptors.cleaned_searchable, Descriptors.cleaned_facetable, Descriptors.cleaned_displayable]) {
          #   t.temporal_coverage_lang(:path=>{:attribute=> "xml:lang"})
          # }
          # t.geocode_point(:ref=>:geographical_coverage, :attributes=> {"xsi:type"=>"marcterms:Point"}, :index_as=> [Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          # t.geocode_point(:ref=>:geographical_coverage, :attributes=> {"xsi:type"=>"marcterms:Point"}, :index_as=> [Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          # t.geocode_box(:ref=>:geographical_coverage, :attributes=> {"xsi:type"=>"marcterms:Box"}, :index_as=> [Descriptors.cleaned_searchable, Descriptors.cleaned_displayable])
          #
      ...
      def metadata_path field
        recognised_attributes = [ :record
                                  # :title, :rights, :description, :language, :subject, :subject_lang, :date, :contributor,
      ...
      def self.xml_template
        builder = Nokogiri::XML::Builder.new do |xml|
          xml.marc(
            "xmlns:marc" => "http://purl.org/marc/elements/1.1/",
            "xmlns:xsi"=>"http://www.w3.org/2001/XMLSchema-instance",
            "xsi:schemaLocation" => "http://www.loc.gov/MARC21/slim http://www.loc.gov/standards/marcxml/schema/MARC21slim.xsd") {

            xml.record
            # xml['marc'].title
            # xml['marc'].description
          }
        end
        return builder.doc
      end
